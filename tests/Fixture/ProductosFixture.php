...
class ProductosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'descripcion_prod' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'productos_ibfk_1' => ['type' => 'foreign', 'columns' => ['id_categoria'], 'references' => ['categoria', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'descripcion_prod' => 'Lorem ipsum dolor sit amet',
