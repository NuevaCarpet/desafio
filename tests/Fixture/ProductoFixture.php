...
class ProductoFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'Nombre_prod' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'producto_ibfk_1' => ['type' => 'foreign', 'columns' => ['categoria_id'], 'references' => ['categoria', 'id'], 'update' => 'noAction', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
